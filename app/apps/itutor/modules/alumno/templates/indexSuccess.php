...
<?php echo form_tag('alumno/listado', 'name=formulario') ?>
...
<tr>
  ...
  <th></th>
  <th><?php echo __('Listado de alumnos') ?></th>
</tr>
</thead>
<tbody>
<tr class="i">
...
<?php echo link_to_function(__('Listado'), "enviar()"); ?>
 ...
 <td><div class="list_alum"><?php echo link_to(__('Todos los alumnos'),'alumno/list');?></div></td>
</tr>
</tbody>
</table>
<hr />
