...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Grupos - Evaluaciones') ?></h1>
</div>
<div id="listado">
<table cellspacing="0">
<thead>
...
<tr class="<?php echo $fila ?>">
    <td><?php echo link_to($grupoev->getId(), 'grupoevaluacion/show?id='.$grupoev->getId()) ?></td>
      <td><?php 
      foreach ($grupos as $grupo):
          if ($grupo->getId() == $grupoev->getGrupoId())
          {
      ...
      foreach ($evaluaciones as $evaluacion):
          if ($evaluacion->getId() == $grupoev->getEvaluacionId())
          {
...
<div id="linea"></div>
<div class="add">
<?php echo link_to (__('Nuevo'), 'grupoevaluacion/create') ?>
</div>
</div>
</div>