...
<tr class="<?php echo $fila ?>">
      ...
      if ($grupo == 0)
      {
        foreach ($horarios as $horario):
          ...
          {
            echo link_to('Introducir Notas', 'prueba/notasedit?prueba='.$prueba->getId().'&grupo='.$horario->getGrupoId().'&grupoid='.$horario->getGrupoId().'&fecha='.strtotime($prueba->getFecha()));
          } 
        endforeach;
      }
      ?> 
      ...
      <td>
      <?php
         echo link_to (image_tag('/images/iconos/view1.png'), 'prueba/show?id='.$prueba->getId().'&grupoid=0&fecha='.$fecha);
