...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Visualizar profesor') ?></h1>
</div>
<div id="mostrar">
...
<tr>
  <th>&nbsp;</th>
  <th id="sf_admin_list_th_id"><?php echo __('Datos profesor') ?></th>
</tr>
</thead>
<tbody>
<tr>
<th><?php echo __('Id') ?>: </th>
<td class="i"><?php echo $profesor->getId() ?></td>
</tr>
<tr>
...
<td class="i"><?php echo $profesor->getCodigo() ?></td>
</tr>
<tr>
<th><?php echo __('Perfil') ?>: </th>
<td class="p"><?php echo $perfil->getNombre() ?></td>
</tr>
<tr>
<th><?php echo __('Email') ?>: </th>
<td class="i"><?php echo $profesor->getEmail() ?></td>
</tr>
<tr>
<th><?php echo __('Activo') ?>: </th>
<td class="p"><?php echo $profesor->getActivo() ?></td>
</tr>
<tr>
<th><?php echo __('Actualizado') ?>: </th>
<td class="i"><?php echo $profesor->getUpdatedAt() ?></td>
</tr>
</tbody>
</table>
...
<div id="linea"></div>	
<div class="edit">
<?php echo link_to(__('Editar'), 'profesor/edit?id='.$profesor->getId()) ?>
</div>
<div class="list">
<?php echo link_to(__('Listado'), 'profesor/list') ?>
</div>
</div>
</div>
