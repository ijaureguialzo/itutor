...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Faltas del grupo') ?> <?php echo $grupo->getNombre()?></h1>
</div>
<?php 
...
{
 if ($falta->getAsignaturaId() == $asignatura->getId() && $falta->getEvaluacionId() == $evaluacion->getId())
 {  
...
<td><?php echo __('Total de faltas') ?> <?php echo $total?> | <?php echo __('Faltas sin justificar') ?> <?php echo $nojustif?> | <?php echo __('Faltas justificadas') ?> <?php echo $justif?>
</td>
</tr>
<?php
endforeach;
...
<div class="exit">
<?php 
echo link_to(__('Volver'), 'falta/recgrupolist?fecha='.$fecha); 
?>
