...
<?php echo form_tag('falta/asigalumnolistado', 'name=formulario') ?>
...
<thead>
<tr>
  <th colspan="4"><?php echo __('Listado por alumno, asignatura y evaluación') ?></th>
</tr>
</thead>
<tbody>
<tr class="i">
 ...
 <td style="height: 40px;"><?php echo __('Escoge alumno') ?> <?php echo select_tag('alumno_id', objects_for_select(
  AlumnoPeer::doSelect($d),
  'getId',
  'getNombre',
  0
 ))?>
