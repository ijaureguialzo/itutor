...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Evaluaciones') ?></h1>
</div>
<div id="listado">
<table cellspacing="0">
<thead>
...
<tr class="<?php echo $fila ?>">
    <td><?php echo link_to($evaluacion->getId(), 'evaluacion/show?id='.$evaluacion->getId()) ?></td>
      <td><?php echo $evaluacion->getTitulo() ?></td>
      <td><?php echo format_date($evaluacion->getFechaini()) ?></td>
      <td><?php echo format_date($evaluacion->getFechafin()) ?></td>
  </tr>
<?php
$x++; 
endforeach; ?>
...
<div id="linea"></div>	
<div class="add">
<?php echo link_to (__('Nuevo'), 'evaluacion/create') ?>
</div>
</div>
</div>
