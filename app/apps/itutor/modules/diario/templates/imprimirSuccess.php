...
<td>
    <?php 
        ...
        {  
          echo date('d-m-Y',strtotime($diario->getFecha()));
        }
        if ($sf_user->getCulture() == 'eu')
        {  
          echo date('Y-m-d',strtotime($diario->getFecha())); 
        }  
    ?>           
</td>
<td>
...
<td class="datos_diario">
      <?php echo $diario->getActividad(); ?>
</td>
<td colspan="2" class="datos_diario">
      <?php echo $diario->getUdidactica(); ?>
</td>
</tr>
<?php
$x++; 
