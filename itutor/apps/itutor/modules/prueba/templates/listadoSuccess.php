...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Prueba realizada el') ?> <?php 
      include_component ('principal','dias', array (
      'dia' => $dia
      ));?> <?php echo __('a') ?> <?php echo $hora + 1 ?> <?php echo __('hora del') ?> 
...
<tr class="<?php echo $fila ?>">
      ...
      ?></td>
      <td><?php echo link_to(__('Introducir Notas'), 'prueba/notasedit?prueba='.$prueba->getId().'&grupo='.$grupo.'&grupoid='.$grupoid);?></td>
      <td>
      <?php
         echo link_to (image_tag('/images/iconos/view1.png'), 'prueba/show?id='.$prueba->getId().'&grupoid='.$grupoid);
         echo link_to (image_tag('/images/iconos/edit1.png'), 'prueba/edit?id='.$prueba->getId().'&grupoid='.$grupoid.'&fecha='.strtotime($prueba->getFecha()));
...
echo link_to(__('Volver'), 'prueba/index?fecha='.strtotime($fecha)); 
?>
</div>
</div>
</div>
