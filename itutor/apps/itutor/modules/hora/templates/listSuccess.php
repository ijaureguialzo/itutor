...
<tr class="<?php echo $fila ?>">
    <td><?php echo link_to($hora->getId(), 'hora/show?id='.$hora->getId()) ?></td>
      <td><?php echo $hora->getTramo() ?></td>
      <td><?php 
      if ($hora->getDescanso())
      {
        echo __('SI');      
      ...
      ?></td>
      <td><?php echo $hora->getDescripcion() ?></td>
      <td><?php echo $hora->getActivo() ?></td>
      <td><?php echo $hora->getUpdatedAt() ?></td>
  </tr>
<?php 
$x++;
endforeach; ?>
...
<div id="linea"></div>	
<div class="add">
<?php echo link_to (__('Nuevo'), 'hora/create') ?>
</div>
</div>
</div>