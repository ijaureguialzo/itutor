...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Faltas totales por asignatura') ?></h1>
</div>
<div id="listado">
<?php use_helper('Object') ?>

<?php echo form_tag('falta/totalasigalumnolist', 'name=formulario') ?>
<?php echo input_hidden_tag('fecha', $fecha);?>

<table cellspacing="0">
<thead>
<tr>
  <th><?php echo __('Listado por asignatura') ?></th>
  <th></th>
</tr>
</thead>
<tbody>
