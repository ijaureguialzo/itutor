...
<div id="contenedor">
<div id="titulo">
<h1><?php echo __('Faltas por alumno y asignatura') ?></h1>
</div>
<div id="listado">
<?php use_helper('Object') ?>

<?php echo form_tag('falta/asigalumnolist', 'name=formulario') ?>
<?php echo input_hidden_tag('fecha', $fecha);?>

<table cellspacing="0">
<thead>
<tr>
    <th colspan="2"><?php echo __('Listado por alumno y asignatura') ?></th>
</tr>
</thead>
<tbody>
<tr class="i">
