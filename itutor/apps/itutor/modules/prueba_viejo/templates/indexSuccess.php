...
<thead>
<tr>
  <th style="text-align: left; padding-left: 5px;"><?php echo link_to(image_tag('/images/iconos/date_previous.png'),'prueba/index?fecha='.strtotime("-1 month",$fecha[0]))?></th>
  <th colspan="5"><?php include_component('principal','meses',array(
     'mes' => $fecha['mon'] 
     ));?></th>
  <th style="text-align: right;width: 12px;padding-right: 5px;"><?php echo link_to(image_tag('/images/iconos/date_next.png'),'prueba/index?fecha='.strtotime("+1 month",$fecha[0]))?></th>
</tr>
<tr>
  <th style="text-align: left; padding-left: 5px;"><?php echo link_to(image_tag('/images/iconos/date_previous.png'),'prueba/index?fecha='.strtotime("-7 day",$fecha[0]))?></th>
  ...
  <th style="text-align: right;width: 12px;padding-right: 5px;"><?php echo link_to(image_tag('/images/iconos/date_next.png'),'prueba/index?fecha='.strtotime("+7 day",$fecha[0]))?></th>
</tr>
<tr>
  <?php 
   $dia = $fecha['wday'];
  ...
  endforeach;  
  ?>
  <th><?php echo date($formato,$lunes) ?></th>
  <th><?php echo date($formato,$martes) ?></th>
  <th><?php echo date($formato,$miercoles) ?></th>
  <th><?php echo date($formato,$jueves) ?></th>
  <th><?php echo date($formato,$viernes) ?></th>
  <th style="text-align: right;width: 12px;padding-right: 5px;">&nbsp;</th>
</tr>
</thead>
<tbody>
<?php
     ...
     ?> 
      ...
      foreach ($horarios as $horario):
        ...
        { 
          ...
          if ($lunes_fest == false)
          {
          echo link_to($asig_nombre. "<br />". $grupo_nombre, 'prueba/nuevo?grupo='.$horario->getGrupoId().'&dia='.$horario->getDia().'&hora='.$horario->getHora().'&asignatura='.$asig_id.'&grupoid='.$horario->getGrupoId().'&fecha='.$lunes); 
          }
          else
          {
            echo __('FESTIVO'); 
      ...
      foreach ($horarios as $horario):
        ...
        { 
          ...
          {
          echo link_to($asig_nombre. "<br />". $grupo_nombre, 'prueba/nuevo?grupo='.$horario->getGrupoId().'&dia='.$horario->getDia().'&hora='.$horario->getHora().'&asignatura='.$asig_id.'&grupoid='.$horario->getGrupoId().'&fecha='.$martes); 
          }
          else
          {
            echo __('FESTIVO'); 
      ...
      foreach ($horarios as $horario):
        ...
        { 
          ...
          {
          echo link_to($asig_nombre. "<br />". $grupo_nombre, 'prueba/nuevo?grupo='.$horario->getGrupoId().'&dia='.$horario->getDia().'&hora='.$horario->getHora().'&asignatura='.$asig_id.'&grupoid='.$horario->getGrupoId().'&fecha='.$miercoles); 
          }
          else
          {
            echo __('FESTIVO'); 
      ...
      foreach ($horarios as $horario):
        ...
        { 
          ...
          {
          echo link_to($asig_nombre. "<br />". $grupo_nombre, 'prueba/nuevo?grupo='.$horario->getGrupoId().'&dia='.$horario->getDia().'&hora='.$horario->getHora().'&asignatura='.$asig_id.'&grupoid='.$horario->getGrupoId().'&fecha='.$jueves); 
          }
          else
          {
            echo __('FESTIVO'); 
      ...
      foreach ($horarios as $horario):
        ...
        { 
          ...
          {
          echo link_to($asig_nombre. "<br />". $grupo_nombre, 'prueba/nuevo?grupo='.$horario->getGrupoId().'&dia='.$horario->getDia().'&hora='.$horario->getHora().'&asignatura='.$asig_id.'&grupoid='.$horario->getGrupoId().'&fecha='.$viernes); 
          }
          else
          {
            echo __('FESTIVO'); 
...
<div id="linea"></div>	
<div class="list">
<?php echo link_to (__('Listado'), 'prueba/list?grupo=0&grupoid=0&fecha='.$fecha[0]) ?>
</div>
</div>
</div>
