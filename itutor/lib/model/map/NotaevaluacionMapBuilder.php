...
class NotaevaluacionMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.NotaevaluacionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('notaevaluacion');
		$tMap->setPhpName('Notaevaluacion');
