...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	public function setCodigo($v)
	{
		...
		if ($this->codigo !== $v) {
			$this->codigo = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::CODIGO;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::NOMBRE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->codigo = $rs->getString($startcol + 5);

			$this->nombre = $rs->getString($startcol + 6);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::CODIGO)) $criteria->add(sfGuardUserPeer::CODIGO, $this->codigo);
		if ($this->isColumnModified(sfGuardUserPeer::NOMBRE)) $criteria->add(sfGuardUserPeer::NOMBRE, $this->nombre);
